...
export const reasonsPh: string[] = [
  ...
  'the way you fall asleep in my car like it is the safest place on earth',
  "that you don't need me to fill every silence",
  'that you always know exactly what you want and are not afraid to go get it',
  ...
  'how you turned ordinary uni days into something worth remembering',
  "that you're strange in exactly the ways i find endearing",
  'the version of every trip that only exists because you were in it',
  "the version of me that exists when you're around",
  'that you turned me into a travelling maniac without even trying',
